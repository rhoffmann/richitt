...
export class Migration20200903201515 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "user" ("id" text not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "username" text not null, "password" text not null);');
